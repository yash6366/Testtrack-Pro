...
const createTestCaseSchema = {
  ...
  body: {
    ...
    properties: {
      name: { type: 'string', maxLength: 200, description: 'Test case name' },
...
const updateTestCaseSchema = {
  ...
  body: {
    ...
    properties: {
      ...
      changeNote: { type: 'string', maxLength: 500, description: 'Required summary of changes for this version' },
